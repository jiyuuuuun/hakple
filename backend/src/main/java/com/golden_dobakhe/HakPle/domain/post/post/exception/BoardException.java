...
public class BoardException extends RuntimeException {
    ...
    public static BoardException alreadyReported() {
        return new BoardException(HttpStatus.BAD_REQUEST, "이미 신고한 게시글입니다.");
    }
    
    public static BoardException cannotReportOwnPost() {
        return new BoardException(HttpStatus.BAD_REQUEST, "자신의 게시글은 신고할 수 없습니다.");
    }
}
