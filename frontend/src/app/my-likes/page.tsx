...
export default function MyLikesPage() {
    ...
    // 좋아요한 게시물 데이터 가져오기
    const fetchLikedPosts = async (page = currentPage) => {
        setIsLoading(true)
        setError(null)
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        좋아요를 누른 게시글 목록입니다. 총 <span className="font-semibold">{totalElements}개</span>의 게시글이 있습니다.
                    </p>
                </div>
                ...
                {isLoading ? (
                    ...
                    <div className="bg-white rounded-xl p-10 shadow-md text-center">
                        ...
                        <p className="text-xl text-gray-600 mb-2">좋아요한 게시글이 없습니다</p>
                        <p className="text-gray-500 mb-6">관심 있는 게시글에 좋아요를 눌러보세요!</p>
                        <button 
                            onClick={() => router.push('/')} 
