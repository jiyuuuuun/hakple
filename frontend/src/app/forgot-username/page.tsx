...
export default function ForgotUsername() {
    ...
    const sendVerificationCode = async () => {
        ...
        try {
            ...
            // 휴대폰 번호 존재 여부 확인
            const phoneCheckResponse = await fetch(`${API_BASE_URL}/api/v1/users/check-phonenum?phoneNum=${phone}`, {
                method: 'GET',
                credentials: 'include',
            });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/v1/usernames/find-username`, {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
